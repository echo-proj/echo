...
public class DocumentVersionController {
  ...
  public ResponseEntity<VersionResponse> createVersion(
    ...
    VersionResponse response = versionService.createVersion(userDetails.getId(), documentId, request);
  ...
  public ResponseEntity<List<VersionResponse>> getDocumentVersions(
      @AuthenticationPrincipal CustomUserDetails userDetails,
      @PathVariable UUID documentId) {
    List<VersionResponse> versions = versionService.getDocumentVersions(userDetails.getId(), documentId);
